...
# shop
insert into shop (id, address, brand, city, industry_industry_id, introduction, latitude, longitude, province, shop_name, company_company_id) values
(4, 'somewhere in Shanghai', 'Apple', 'Shanghai', 1, 'Make Apple great again', 31.203798, 121.466012, 'Shanghai', '瑞金医院', 1);
insert into shop (id, address, brand, city, industry_industry_id, introduction, latitude, longitude, province, shop_name, company_company_id) values
(5, 'somewhere in Shanghai', 'Apple', 'Shanghai', 1, 'Make Apple great again', 31.295241, 121.503894, 'Shanghai', '复旦大学', 1);
insert into shop (id, address, brand, city, industry_industry_id, introduction, latitude, longitude, province, shop_name, company_company_id) values
(6, 'somewhere in Shanghai', 'Apple', 'Shanghai', 1, 'Make Apple great again', 31.238295, 121.499699, 'Shanghai', '东方明珠', 1);
insert into shop (id, address, brand, city, industry_industry_id, introduction, latitude, longitude, province, shop_name, company_company_id) values
(7, 'somewhere in Shanghai', 'Apple', 'Shanghai', 1, 'Make Apple great again', 31.230339, 121.473656, 'Shanghai', '上海市政府', 1);

# jobs
insert into job (begin_apply_date, begin_date, education, end_apply_date, end_date, job_detail, job_name, need_amount, need_gender, salary, shop_shop_id) values
('2019-07-14 16:00:00', '2019-07-16 16:00:00', '高中及以上', '2019-07-15 16:00:00', '2019-07-17 16:00:00', '扮演精神病人', 'seller', 10, 2, 100, 4);
insert into job (begin_apply_date, begin_date, education, end_apply_date, end_date, job_detail, job_name, need_amount, need_gender, salary, shop_shop_id) values
('2019-07-14 16:00:00', '2019-07-16 16:00:00', '不限', '2019-07-15 16:00:00', '2019-07-17 16:00:00', '当一个无用之人', 'seller', 10, 2, 100, 5);
insert into job (begin_apply_date, begin_date, education, end_apply_date, end_date, job_detail, job_name, need_amount, need_gender, salary, shop_shop_id) values
('2019-07-14 16:00:00', '2019-07-16 16:00:00', '高中及以上', '2019-07-15 16:00:00', '2019-07-17 16:00:00', '跳伞运动员', 'seller', 10, 2, 100, 6);
insert into job (begin_apply_date, begin_date, education, end_apply_date, end_date, job_detail, job_name, need_amount, need_gender, salary, shop_shop_id) values
('2019-07-14 16:00:00', '2019-07-16 16:00:00', '大学本科及以上', '2019-07-15 16:00:00', '2019-07-17 16:00:00', '炸弹小组技术专家', 'seller', 10, 2, 100, 7);