...
execute("docker run --rm -d --net=host -e MYSQL_ROOT_PASSWORD=root -e TZ='America/Los_Angeles' --name mysql-inner mysql --lower_case_table_names=1 --character-set-server=utf8mb4 --collation-server=utf8mb4_unicode_ci --skip-character-set-client-handshake")
